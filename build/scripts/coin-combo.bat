...
@rem ##########################################################################
@rem
@rem  coin-combo startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and COIN_COMBO_OPTS to pass JVM options to this script.
...
@rem Execute coin-combo
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %COIN_COMBO_OPTS%  -classpath "%CLASSPATH%" Coin %CMD_LINE_ARGS%
...
:fail
rem Set variable COIN_COMBO_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%COIN_COMBO_EXIT_CONSOLE%" exit 1
exit /b 1
